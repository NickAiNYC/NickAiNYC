...
**Portable Agent Loops · Verifiable Execution · Governed AI Systems**
...
> **Agent logic should not be trapped inside one framework, SDK, prompt chain, or vendor runtime.**
...
```text
Write once. Run anywhere. Inspect everything. Replay anything.
```
  ...
  <tr>
    <td width="55%" valign="top">
      ...
      <ul>
        ...
        <li><strong>Adapters</strong> — a clean bridge between the spec and execution engines: Hermes, OpenClaw, LangGraph, CrewAI</li>
        ...
        <li><strong>Eternal Memory</strong> — FTS5-based recall with 96% retrieval accuracy</li>
        <li><strong>Zero-Infrastructure</strong> — SQLite message bus, no Redis, no Kafka, no microservices</li>
      </ul>
    </td>
...
infini inspect runs/latest/</code></pre>
      <p><sub>Validate. Run. Inspect. Replay. All from a single CLI.</sub></p>
      <br/>
...
AGENTS:
  - { name: researcher, role: builder, model_tier: sonnet }
  - { name: verifier,  role: critic, model_tier: haiku }

STEPS:
  - { id: s1, name: find-sources, action: run, uses: browser, agent: researcher }
  - { id: s2, name: verify, action: run, uses: verify_citations, agent: verifier, depends_on: [s1] }
...
```text
Loopfile → Validation → Engine → Adapter → Execution → Trace → Replay → Observatory
```
...
<table>
  ...
  <tr>
    <td width="25%" valign="top"><strong>Core Stack</strong></td>
    <td valign="top">Next.js, React, FastAPI, Node.js, SQLite, Postgres</td>
  </tr>
  <tr>
    <td width="25%" valign="top"><strong>AI Systems</strong></td>
    <td valign="top">Agent loops, verification, prompt systems, trace design, adapters, replay, governance controls, MCP</td>
  </tr>
  <tr>
    <td width="25%" valign="top"><strong>Philosophy</strong></td>
    <td valign="top">Spec-first, readable artifacts, working demos, clean contribution paths, practical operator workflows</td>
  </tr>
</table>
  ...
  <tr>
    <td width="50%" valign="top">
      ...
      <ul>
        ...
        <li><strong>Adapter SDK</strong> — clean bridge between spec and execution engines</li>
        <li><strong>Eternal Memory</strong> — FTS5-based recall with 96% retrieval accuracy</li>
        <li><strong>3-Agent Orchestration</strong> — Planner/Worker/Inspector supervision</li>
        <li><strong>Zero-Infrastructure</strong> — SQLite message bus, no external dependencies</li>
        <li><strong>MCP Runtime</strong> — live LLM execution with 7 built-in tools</li>
      </ul>
    </td>
    <td width="50%" valign="top">
      <h3>🔨 Building</h3>
      <ul>
        ...
        <li><strong>Observatory UI</strong> — 3D trace visualization with Three.js</li>
        <li><strong>Governed Systems</strong> — Scrutexity, AuditGPT, Contento</li>
        <li><strong>Recovery Workflows</strong> — AI visibility and failure handling</li>
      </ul>
    </td>
  </tr>
</table>
...
I'm building the standard layer for autonomous work — infrastructure that makes AI agents portable, inspectable, and governable.

| Principle | What It Means |
|---|---|
| **Portable** | Write agent logic once. Run it through any engine. |
| **Inspectable** | Every run produces a trace. Every trace can be replayed. |
| **Verifiable** | Every loop has verification. Every verification has confidence. |
| **Governable** | Budgets, stop conditions, policies, and audit trails. |
| **Open** | Specs, schemas, adapters, and registries anyone can extend. |
